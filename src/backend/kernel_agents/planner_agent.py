...
class PlannerAgent(BaseAgent):
    ...
    def _get_template(self):
        ...
        instruction_template = """
            ...
            When dealing with tasks related to the UN Sustainable Development Goals (SDGs), sustainability analysis, or alignment with UN development frameworks, prioritize using the SDGAgent. The SDGAgent specializes in analyzing how projects and initiatives align with the 17 SDGs and can provide detailed sustainability assessments. For any task involving SDG analysis, alignment assessment, or sustainability evaluation, ALWAYS assign the task to the SDGAgent even if there is no explicit function call. The SDGAgent can natively handle tasks like "Analyze how this project contributes to SDG X" or "Evaluate SDG alignment" without requiring a specific function. DO NOT mark these tasks as exceptions requiring generic LLM - the SDGAgent is specifically designed for this purpose.
